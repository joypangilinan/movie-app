        ...
        if (req.query.search) {
            ...
            mongoose.connection.db
                ...
                .then(counts => {
                    mongoose.connection.db
                        .collection('movieDetails')
                        .find({ actors: regex }, { projection: { "title": 1, "poster": 1, "year": 1, "genres": 1, "imdb.votes": 1, "imdb.rating": 1, "tomato.rating": 1, "rated": 1, "plot": 1 } })
                        .skip(perPage * (page - 1))
                        .limit(perPage)
                        .toArray(function (err, movie) {
                            posterReplace(movie)
        ...
        if (req.query.search) {
            ...
            mongoose.connection.db
                ...
                .then(counts => {
                    mongoose.connection.db
                        .collection('movieDetails')
                        .find({ $or: [{ title: regex }, { actors: regex }, { genres: regex }] }, { projection: { "title": 1, "poster": 1, "year": 1, "genres": 1, "imdb.votes": 1, "imdb.rating": 1, "tomato.rating": 1, "rated": 1, "plot": 1 } })
                        .skip(perPage * (page - 1))
                        .limit(perPage)
                        .toArray(function (err, movie) {
                            posterReplace(movie)
        ...
        if (req.query.search) {
            ...
            mongoose.connection.db
                ...
                .then(counts => {
                    mongoose.connection.db
                        .collection('movieDetails')
                        .find({ genres: regex }, { projection: { "title": 1, "poster": 1, "year": 1, "genres": 1, "imdb.votes": 1, "imdb.rating": 1, "tomato.rating": 1, "rated": 1, "plot": 1 } })
                        .skip(perPage * (page - 1))
                        .limit(perPage)
                        .toArray(function (err, movie) {
                            posterReplace(movie)
